...
path1 = f"../data/video_frames/masked_walking/frame_0023.png" # the two images to blend
path2 = f"../data/video_frames/masked-jogging/frame_0029.png"
...
for i in range(1, 26):
    ...
    save_ot_interpolated_image(gamma, t, f"../output/frame_{i:04d}.png", size=(WIDTH, HEIGHT))